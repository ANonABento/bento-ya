      ...
      >
        ...
        >
            ...
            {!isPanelCollapsed && (
              <>
                <button
                  type="button"
                  onClick={() => {
                    setSidebarMode(sidebarMode === 'history' ? null : 'history')
                  }}
                ...
                <button
                  type="button"
                  onClick={() => {
                    setSidebarMode(sidebarMode === 'dashboard' ? null : 'dashboard')
                  }}
                  className={`flex h-6 w-6 items-center justify-center rounded-md transition-colors ${
          ...
          <div className="absolute left-1/2 flex -translate-x-1/2 items-center gap-2">
            ...
            {isProcessing && <ProcessingIndicator startTime={chat.streaming.startTime} />}
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            {!isPanelCollapsed && (
              <button
                type="button"
                onClick={() => {
                  setPanelDock(isRightDock ? 'bottom' : 'right')
                }}
                ...
                <div className="flex flex-1 flex-col overflow-hidden">
                  ...
                  <ChatInput
                    ...
                    onAttachmentError={(err) => {
                      setLocalError(`${err.file}: ${err.message}`)
                    }}
