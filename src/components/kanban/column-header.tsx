    ...
    case 'inbox':
      return (
        ...
        >
          <path
            fillRule="evenodd"
            d="M2 4a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V4Zm2.22 1.47a.75.75 0 0 0 0 1.06l2.25 2.25a.75.75 0 0 0 1.06 0l2.25-2.25a.75.75 0 0 0-1.06-1.06L8 6.19 7.28 5.47a.75.75 0 0 0-1.06 0l-.72.72Z"
            clipRule="evenodd"
          />
        </svg>
      )
    ...
    case 'rocket':
      return (
        ...
        >
          <path
            fillRule="evenodd"
            d="M9.808 1.69a.75.75 0 0 1 .712.298l3.5 4.5a.75.75 0 0 1-.988 1.122l-1.677-1.31-3.042 5.377-1.5-1.5a.75.75 0 0 0-1.06 0l-2.47 2.47a.75.75 0 1 1-1.06-1.06l3-3a.75.75 0 0 1 1.06 0l1.5 1.5L10.5 4.4l-1.56-1.22a.75.75 0 0 1 .868-1.49Z"
            clipRule="evenodd"
          />
        </svg>
      )
    case 'archive':
      return (
        ...
        >
          ...
          <path
            fillRule="evenodd"
            d="M13 6H3v5a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V6ZM5.72 7.47a.75.75 0 0 1 1.06 0L8 8.69l1.22-1.22a.75.75 0 1 1 1.06 1.06l-1.75 1.75a.75.75 0 0 1-1.06 0L5.72 8.53a.75.75 0 0 1 0-1.06Z"
            clipRule="evenodd"
          />
        </svg>
      )
    default:
      return (
        ...
        >
          <path
            fillRule="evenodd"
            d="M2.5 3.5c0-.56.44-1 1-1h9a1 1 0 1 1 0 2h-9a1 1 0 0 1-1-1ZM2.5 8c0-.56.44-1 1-1h9a1 1 0 1 1 0 2h-9a1 1 0 0 1-1-1ZM3.5 11.5a1 1 0 1 0 0 2h9a1 1 0 1 0 0-2h-9Z"
            clipRule="evenodd"
          />
        </svg>
      )
  ...
  return (
    <>
      <div className="flex items-center gap-2 px-3 py-2">
        ...
        {scriptTrigger && (
          <span
            className="truncate rounded bg-accent/10 px-1.5 py-0.5 text-[10px] font-medium text-accent"
                ...
                >
                  ...
                  >
                    ...
                    >
                      <path
                        fillRule="evenodd"
                        d="M6.455 1.45A.5.5 0 0 1 6.952 1h2.096a.5.5 0 0 1 .497.45l.186 1.858a4.996 4.996 0 0 1 1.466.848l1.703-.769a.5.5 0 0 1 .639.206l1.048 1.814a.5.5 0 0 1-.142.656l-1.517 1.09a5.026 5.026 0 0 1 0 1.694l1.517 1.09a.5.5 0 0 1 .142.656l-1.048 1.814a.5.5 0 0 1-.639.206l-1.703-.769c-.433.36-.928.649-1.466.848l-.186 1.858a.5.5 0 0 1-.497.45H6.952a.5.5 0 0 1-.497-.45l-.186-1.858a4.993 4.993 0 0 1-1.466-.848l-1.703.769a.5.5 0 0 1-.639-.206L1.413 10.4a.5.5 0 0 1 .142-.656l1.517-1.09a5.026 5.026 0 0 1 0-1.694l-1.517-1.09a.5.5 0 0 1-.142-.656L2.46 3.4a.5.5 0 0 1 .639-.206l1.703.769c.433-.36.928-.649 1.466-.848l.186-1.858ZM8 10.5a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Z"
                        clipRule="evenodd"
                      />
                    </svg>
                    Configure
        ...
        >
          ...
          >
            ...
            <p className="mb-4 text-sm text-text-secondary">
              This will queue all {taskCount} task{taskCount !== 1 ? 's' : ''} in {name} for
