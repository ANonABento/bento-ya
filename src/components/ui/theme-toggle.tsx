...
export function ThemeToggle() {
  ...
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.95 }}
      className="flex items-center gap-1.5 rounded-lg border border-border-default bg-surface px-2 py-1.5 text-xs text-text-secondary transition-colors hover:border-accent hover:text-text-primary"
